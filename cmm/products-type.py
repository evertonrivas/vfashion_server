...
class CategoryList(Resource):
    ...
    def get(self):
        ...
        try:
            if search=="":
                rquery = CmmProductType.query.filter(CmmProductType.trash==False)
            else:
                rquery = CmmProductType.query.filter(sa.and_(CmmProductType.trash==False,CmmProductType.name.like(search)))
