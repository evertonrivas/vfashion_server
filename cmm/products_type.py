...
from models import CmmProductType,db
...
class CategoryList(Resource):
    ...
    def get(self):
        ...
        try:
            if search=="":
                rquery = CmmProductType.query.filter(CmmProductType.trash==False).order_by(CmmProductType.name)
            else:
                rquery = CmmProductType.query.filter(and_(CmmProductType.trash==False,CmmProductType.name.like(search))).order_by(CmmProductType.name)
